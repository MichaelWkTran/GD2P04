...
#include "../Scripts/Camera.h" //For accessing the camera
#include "../Scripts/TinyObjectLoader.h" //For loading models
#include "../Scripts/Lights.h" //For adding lights to the scene
#include "../Scripts/Shader.h" //For creating shaders
#include "../Scripts/Texture.h" //For creating textures
#include "../Scripts/CubeSkybox.h" //For creating a skybox
#include "../Scripts/Main.h" //For accessing viewport and keyboard input
#include <iostream> //For printing messages to console
#include "GeoStar.h"
#include "GeoSphere.h"
#include "../Scripts/GenerateMesh.h"
#include "TessModel.h"
